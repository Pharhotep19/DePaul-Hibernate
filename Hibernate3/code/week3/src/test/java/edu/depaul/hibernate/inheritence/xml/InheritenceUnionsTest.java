...
public class InheritenceUnionsTest extends TestCase {

	private List<String> names = Arrays.asList(new String [] {"Michael Minella", "Terry Minella", "Rudy Neuberger", "Russ Benes"});
